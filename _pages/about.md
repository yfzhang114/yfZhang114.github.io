...
3. Yifan Zhang, Weiqiang Ren, Zhen Jia, Zhang Zhang, Liang Wang, Tieniu Tan, ["Focal and Efficient IOU Loss for Accurate Bounding Box Regression"](../files/cvpr final.pdf) under review on Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR 2021)
